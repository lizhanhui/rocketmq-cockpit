...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb">
                <li class="active"><span class="badge" style="background-color: green;">1</span> Launch New Project</li>
                <li><span class="badge" style="background-color: orangered;">2</span> Create Consumer Groups</li>
                <li><span class="badge" style="background-color: red;">3</span> Create Topics</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-xs-8 col-xs-offset-2 text-left table-responsive">
            <table class="table table-bordered">
                <tr>
                    ...
                    <td><input type="text" class="form-control projectName" placeholder="projectName"></input></td>
                </tr>
                <tr>
                    <td><label>Description</label></td>
                    <td><input type="text" class="form-control projectDesc" placeholder="projectDesc"></input></td>
                </tr>
                <tr>
    ...
    <div id="addConsumerGroupDIV" style="display:none">
        <div class="col-xs-8 col-xs-offset-2 text-left table-responsive">
            <table class="table table-bordered">
                <tr>
                    <td>cluster_name:</td>
                    <td><input type="text" class="form-control CGcluster_name" placeholder="cluster_name"></td>
                </tr>
                ...
                <tr>
                    <td>group_name:</td>
                    <td><input type="text" class="form-control CGgroup_name" placeholder="group_name"></td>
                </tr>
                <tr>
        ...
        <div class="container-fluid">
            <div id="addTopicDIV" class="col-xs-8 col-xs-offset-2 text-left table-responsive">
                <table class="table table-bordered">
                    <tr>
                        <td>Topic:</td>
                        <td>  <input type="text" class="form-control Ttopic" placeholder="topic"></td>
                    </tr>
                    <tr class="hide">
